...
var file_pixkey_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x6b, 0x73, 0x6d, 0x72,
	...
	0x62, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x6b, 0x73, 0x6d, 0x72, 0x2e, 0x63, 0x6f, 0x64, 0x65,
	...
	0x77, 0x61, 0x6c, 0x6c, 0x65, 0x6b, 0x73, 0x6d, 0x72, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x70, 0x69,
	...
	0x20, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x6b, 0x73,
	0x6d, 0x72, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x70, 0x69, 0x78, 0x2e, 0x50, 0x69, 0x78, 0x4b, 0x65,
	0x79, 0x1a, 0x24, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65,
	0x6b, 0x73, 0x6d, 0x72, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x70, 0x69, 0x78, 0x2e, 0x50, 0x69, 0x78,
...
var file_pixkey_proto_goTypes = []interface{}{
	(*PixKeyRegistration)(nil),  // 0: github.walleksmr.codepix.PixKeyRegistration
	(*PixKey)(nil),              // 1: github.walleksmr.codepix.PixKey
	(*Account)(nil),             // 2: github.walleksmr.codepix.Account
	(*PixKeyInfo)(nil),          // 3: github.walleksmr.codepix.PixKeyInfo
	(*PixKeyCreatedResult)(nil), // 4: github.walleksmr.codepix.PixKeyCreatedResult
}
var file_pixkey_proto_depIdxs = []int32{
	2, // 0: github.walleksmr.codepix.PixKeyInfo.account:type_name -> github.walleksmr.codepix.Account
	0, // 1: github.walleksmr.codepix.PixService.RegisterPixKey:input_type -> github.walleksmr.codepix.PixKeyRegistration
	1, // 2: github.walleksmr.codepix.PixService.Find:input_type -> github.walleksmr.codepix.PixKey
	4, // 3: github.walleksmr.codepix.PixService.RegisterPixKey:output_type -> github.walleksmr.codepix.PixKeyCreatedResult
	3, // 4: github.walleksmr.codepix.PixService.Find:output_type -> github.walleksmr.codepix.PixKeyInfo
